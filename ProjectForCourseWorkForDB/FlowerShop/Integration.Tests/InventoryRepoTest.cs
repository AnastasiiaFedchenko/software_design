...
namespace Integration.Tests
{
    public class InventoryRepoTest
    {
        ...
        public InventoryRepoTest(ITestOutputHelper output)
        {
            _output = output;
            _inventoryRepo = new InventoryRepo("Host=127.0.0.1;Port=5432;Database=FlowerShop;Username=postgres;Password=5432");
