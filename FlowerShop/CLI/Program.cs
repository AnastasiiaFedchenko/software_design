...
class Menu
{
    ...
    public Menu(ILoggerFactory loggerFactory, string connectionString, string pythonPath, string scriptPath)
    {
        ...
        serviceProvider = new ServiceCollection()
            ...
            .AddSingleton<IUserRepo>(provider => new UserRepo(new NpgsqlConnectionFactory(_connectionString)))
            .AddSingleton<IInventoryRepo>(provider => new InventoryRepo(new NpgsqlConnectionFactory(_connectionString)))
            .AddSingleton<IReceiptRepo>(provider => new ReceiptRepo(new NpgsqlConnectionFactory(_connectionString)))
